...
with st.sidebar:
    ...
    input_method = st.radio("Input Method", ["Upload File", "YouTube URL"], horizontal=True)
    ...
    if input_method == "Upload File":
        ...
        st.caption("⚠️ YouTube may block downloads on cloud. Use file upload if it fails.")
...
if st.session_state.result:
    ...
    <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;padding:5rem 2rem;text-align:center">
        ...
        <div style="color:var(--text-muted);font-size:0.85rem;max-width:380px;line-height:1.7">
            Upload a file or paste a YouTube URL in the sidebar, choose your language, and hit <strong>Analyse</strong> to get started.
        </div>
